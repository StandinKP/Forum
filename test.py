...
response = ses.verify_email_identity(
  EmailAddress = 'kaushalpp01@gmail.com'
)
...
response = ses.delete_identity(
  Identity = 'kaushalpp01@gmail.com'
)
              ...
              <table border="0" cellpadding="0" cellspacing="0">
                <tr>
                  <td class="content-block powered-by">
                    Powered by <a href="http://ogtech.in">Chatbot</a>.
                  </td>
                </tr>
              </table>
            </div>
...
response = ses.send_templated_email(
    Source="kaushalpp01@gmail.com",
    Destination={
        "ToAddresses": [
            "kaushalpp01@gmail.com",
        ]
    },
    ReplyToAddresses=[
        "kaushalpp01@gmail.com",
                              ...
                              <td align="left">
                                <table border="0" cellpadding="0" cellspacing="0">
                                  <tbody>
                                    <tr>
                                      <td>
                                        <a href="{{hostname}}/verify_email/{{token}}" target="_blank"
                                          >confirm email</a
                                        >
                                      </td>
                                    </tr>
